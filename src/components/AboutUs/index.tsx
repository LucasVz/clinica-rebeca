  ...
  return (
    <Container id="Sobre">
      ...
      <h2>
        ...
        melhores marcas de cosméticos home Care de excelente qualidade, sala de
        atendimento individual previamente pensada para proporcionar
        relaxamento,discrição e bem está. Devidamente equipada e climatizada
        para melhorar ainda mais sua experiência.
      </h2>
      <Galery>
